...
public class AddStudent extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == submit) {
            ...
            String branch = (String) cbbranch.getSelectedItem();//getSelectedItem() is an object that's why need to typecast it to String
            ...
            try {//to insert the data into the table
                ...
                Conn con = new Conn();
                con.s.executeUpdate(query);//executes DML commands
